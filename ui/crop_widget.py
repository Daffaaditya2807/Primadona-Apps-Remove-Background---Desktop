    ...
    def resize_crop_rect(self, handle_index, new_point):
        ...
        if handle_index == 0:  # top-left
            ...
            if self.aspect_ratio:
                ...
                self.crop_rect = QRect(rect.left(), rect.bottom() - new_height, self.crop_rect.width(), new_height)
            ...
            if self.aspect_ratio:
                ...
                self.crop_rect = QRect(rect.left(), rect.top(), self.crop_rect.width(), new_height)
            ...
            if self.aspect_ratio:
                ...
                self.crop_rect = QRect(rect.right() - new_width, rect.top(), new_width, self.crop_rect.height())
            ...
            if self.aspect_ratio:
                ...
                self.crop_rect = QRect(rect.left(), rect.top(), new_width, self.crop_rect.height())
